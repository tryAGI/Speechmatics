...
namespace Speechmatics
{
    ...
    public sealed partial class DeleteJobResponse
    {
        ...
        public required global::Speechmatics.JobDetails Job { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteJobResponse" /> class.
        /// </summary>
        /// <param name="job">
        /// Document describing a job. JobConfig will be present in JobDetails returned for GET jobs/{id} request in SaaS and in Batch Appliance, but it will not be present in JobDetails returned as item in RetrieveJobsResponse in case of Batch Appliance.
        /// </param>
        ...
        public DeleteJobResponse(
            global::Speechmatics.JobDetails job)
        {
