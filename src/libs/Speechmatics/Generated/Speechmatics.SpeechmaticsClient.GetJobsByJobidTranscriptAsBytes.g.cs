...
namespace Speechmatics
{
    public partial class SpeechmaticsClient
    {
        ...
        private static readonly global::Speechmatics.EndPointSecurityRequirement s_GetJobsByJobidTranscriptAsBytesSecurityRequirement0 =
        ...
        private static readonly global::Speechmatics.EndPointSecurityRequirement[] s_GetJobsByJobidTranscriptAsBytesSecurityRequirements =
            new global::Speechmatics.EndPointSecurityRequirement[]
                ...
                else
                {
                    await global::Speechmatics.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                throw global::Speechmatics.ApiException<byte[]>.Create(
                            ...
                            if ((int)__response.StatusCode == 410)
                            {
                                ...
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        ...
                                        __value_410 = (byte[]?)global::System.Text.Json.JsonSerializer.Deserialize(__content_410, typeof(byte[]), JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_410 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            try
                            {
                                ...
                                return new global::Speechmatics.ResponseStream(__response, __content);
                            }
                            catch (global::System.Exception __ex)
                            {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Speechmatics.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Speechmatics.AutoSDKHttpResponse<byte[]>> GetJobsByJobidTranscriptAsBytesAsResponseAsync(
            string jobid,
            global::Speechmatics.GetJobsTranscriptFormat? format = default,
            int? wait = default,
            global::Speechmatics.AutoSDKRequestOptions? requestOptions = default,
                    ...
                    await global::Speechmatics.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::Speechmatics.AutoSDKHttpResponse<byte[]>(
                                        statusCode: __response.StatusCode,
