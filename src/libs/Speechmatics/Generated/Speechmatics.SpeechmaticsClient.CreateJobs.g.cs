...
namespace Speechmatics
{
    public partial class SpeechmaticsClient
    {
            ...
            if (xSmProcessingData != default)
            {
                __httpRequest.Headers.TryAddWithoutValidation("X-SM-Processing-Data", xSmProcessingData.ToString());
                            ...
                            if (request.DataFile != default)
                            {
                                ...
                                __contentDataFile.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.DataFilename is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.DataFilename) ?? string.Empty).ToLowerInvariant() switch
                                        {
                                            ".aac" => "audio/aac",
                                            ".flac" => "audio/flac",
                                            ".gif" => "image/gif",
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::Speechmatics.CreateJobsRequest
            {
                Config = config,
                DataFile = global::System.Array.Empty<byte>(),
                DataFilename = dataFilename,
                TextFile = global::System.Array.Empty<byte>(),
                TextFilename = textFilename,
            };
            PrepareArguments(
                client: HttpClient);
            ...
            if (xSmProcessingData != default)
            {
                __httpRequest.Headers.TryAddWithoutValidation("X-SM-Processing-Data", xSmProcessingData.ToString());
                            ...
                            if (dataFile != default)
                            {
                                ...
                                var __contentDataFile = new global::System.Net.Http.StreamContent(dataFile);
                                __contentDataFile.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.DataFilename is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.DataFilename) ?? string.Empty).ToLowerInvariant() switch
                            ...
                            if (textFile != default)
                            {
                                ...
                                var __contentTextFile = new global::System.Net.Http.StreamContent(textFile);
                                __contentTextFile.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.TextFilename is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.TextFilename) ?? string.Empty).ToLowerInvariant() switch
