...
namespace Speechmatics
{
    public partial class SpeechmaticsClient
    {
        ...
        /// console.log(json);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Speechmatics.RetrieveJobsResponse> GetJobsAsync(
        ...
        {
            var __response = await GetJobsAsResponseAsync(
        ...
        /// console.log(json);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Speechmatics.AutoSDKHttpResponse<global::Speechmatics.RetrieveJobsResponse>> GetJobsAsResponseAsync(
            global::System.DateTime? createdBefore = default,
            int? limit = default,
            bool? includeDeleted = default,
            global::Speechmatics.AutoSDKRequestOptions? requestOptions = default,
                ...
                else
                {
                    await global::Speechmatics.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 422)
                            {
                                ...
                                global::Speechmatics.ErrorResponse? __value_422 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_422 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_422 = global::Speechmatics.ErrorResponse.FromJson(__content_422, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_422 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Speechmatics.RetrieveJobsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Speechmatics.AutoSDKHttpResponse<global::Speechmatics.RetrieveJobsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Speechmatics.RetrieveJobsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
