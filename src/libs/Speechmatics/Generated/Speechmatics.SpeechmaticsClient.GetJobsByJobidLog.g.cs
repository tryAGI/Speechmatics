...
namespace Speechmatics
{
    public partial class SpeechmaticsClient
    {
        ...
        private static readonly global::Speechmatics.EndPointSecurityRequirement s_GetJobsByJobidLogSecurityRequirement0 =
        ...
        private static readonly global::Speechmatics.EndPointSecurityRequirement[] s_GetJobsByJobidLogSecurityRequirements =
            new global::Speechmatics.EndPointSecurityRequirement[]
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Speechmatics.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Speechmatics.AutoSDKHttpResponse<string>> GetJobsByJobidLogAsResponseAsync(
            string jobid,
            global::Speechmatics.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
                ...
                else
                {
                    await global::Speechmatics.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 501)
                            {
                                ...
                                global::Speechmatics.ErrorResponse? __value_501 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_501 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_501 = global::Speechmatics.ErrorResponse.FromJson(__content_501, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_501 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
